    ...
    <div class="wrapperAlert">
        <div class="contentAlert">
          ...
          <div class="bottomHalf">   
            <p>Silahkan konfirmasi pemesanan dengan menekan tombol Whatsapp di bawah...</p>
            <a href="https://api.whatsapp.com/send?phone=6281388333641&text=Saya%20telah%20memesan%20kamar%20: " target="_blank" style="text-decoration: none">
              <button>Whatsapp</button>
            </a>            
            <a href="{{ route('kosan') }}"><button id="alertMO" style="background-color: grey">Kembali</button></a>
          </div>
        </div>        
      </div>
</body>
